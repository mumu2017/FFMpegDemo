...
NSString * const ZxVideoParameterMinBufferedDuration = @"ZxVideoParameterMinBufferedDuration";
NSString * const ZxVideoParameterMaxBufferedDuration = @"ZxVideoParameterMaxBufferedDuration";
NSString * const ZxVideoParameterDisableDeinterlacing = @"ZxVideoParameterDisableDeinterlacing";
...
@implementation ZXVideoControlVC
                               ...
                               parameters: (NSDictionary *) parameters
{
    ...
    return [[ZXVideoControlVC alloc] initWithContentPath: path parameters: parameters];
}
                ...
                parameters: (NSDictionary *) parameters
{
    ...
    if (self) {
        ...
        __weak ZXVideoControlVC *weakSelf = self;
        
        KxMovieDecoder *decoder = [[KxMovieDecoder alloc] init];
        
        decoder.interruptCallback = ^BOOL(){
            
            __strong ZXVideoControlVC *strongSelf = weakSelf;
               ...
               withError: (NSError *) error
{
    ...
    if (!error && decoder) {
        ...
        if (_parameters.count) {
            ...
            val = [_parameters valueForKey: ZxVideoParameterMinBufferedDuration];
            if ([val isKindOfClass:[NSNumber class]])
            _minBufferedDuration = [val floatValue];
            
            val = [_parameters valueForKey: ZxVideoParameterMaxBufferedDuration];
            if ([val isKindOfClass:[NSNumber class]])
            _maxBufferedDuration = [val floatValue];
            
            val = [_parameters valueForKey: ZxVideoParameterDisableDeinterlacing];
            if ([val isKindOfClass:[NSNumber class]])
